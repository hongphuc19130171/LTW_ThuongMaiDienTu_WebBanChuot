...
@WebServlet(name = "AdminCheckController", value = "/AdminCheck")
public class AdminCheckEditController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ProductDAO.getInstance().EditProduct(sanpham_id,danhmuc_id,sanpham_name,sanpham_gia,sanpham_giakm,sanpham_active,sanpham_hot,sanpham_soluong,img,img_1,img_2,img_3,img_4);


        request.getRequestDispatcher("AdminCheckEdit.jsp").forward(request,response);
    }
