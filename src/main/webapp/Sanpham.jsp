    ...
    <div class="container py-xl-4 py-lg-2">
        ...
        <div class="row">
            ...
            <div class="agileinfo-ads-display col-lg-9">
                <div class="wrapper">
                    <c:if test="${param.fill == 1}" >
                        <!-- first section -->
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">

                                <c:forEach var = "row_sp" items = "${Pfill1}">
                                            ...
                                            <div class="men-thumb-item text-center">
                                                ...
                                                <div class="men-cart-pro">
                                                    <div class="inner-men-cart-pro">
                                                        <a href="chitietSP?danhmuc=${row_sp.danhmuc_id}&id=${row_sp.sanpham_id}" class="link-product-add-cart">Xem ngay</a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="text-center" >
                            <ul class="pagination justify-content-center">
                                <c:forEach begin="1" end="${endFill1}" var="i1">
                                    <li class="page-item"><a class="page-link" href="Sanpham?fill=1&page=${i1}">${i1}</a></li>
                                </c:forEach>
                    ...
                    <c:if test="${param.fill == 2}" >
                        <!-- first section -->
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">

                                <c:forEach var = "row_sp" items = "${Pfill2}">
                        ...
                        <div class="text-center" >
                            <ul class="pagination justify-content-center">
                                <c:forEach begin="1" end="${endFill2}" var="i1">
                                    <li class="page-item"><a class="page-link" href="Sanpham?fill=2&page=${i1}">${i1}</a></li>
                                </c:forEach>
                    ...
                    <c:if test="${param.fill == 3}" >
                        <!-- first section -->
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">

                                <c:forEach var = "row_sp" items = "${Pfill3}">
                        ...
                        <div class="text-center" >
                            <ul class="pagination justify-content-center">
                                <c:forEach begin="1" end="${endFill3}" var="i1">
                                    <li class="page-item"><a class="page-link" href="Sanpham?fill=3&page=${i1}">${i1}</a></li>
                                </c:forEach>
                    ...
                    <c:if test="${param.fill == 4}" >
                        <h2>Có ${fill4P} sản phẩm với từ khóa "${timkiem}"</h2>
                        <br><br>
                        <!-- first section -->
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">

                                <c:forEach var = "row_sp" items = "${fill4}">
...
<%--        <div class="text-center" >--%>
<%--            <ul class="pagination justify-content-center">--%>
<%--                <c:forEach begin="1" end="${endFill4}" var="i1">--%>
<%--                    <li class="page-item"><a class="page-link" href="Sanpham?fill=4&page=${i1}">${i1}</a></li>--%>
<%--                </c:forEach>--%>
